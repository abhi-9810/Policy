...
if($_SERVER["REQUEST_METHOD"] == "POST"&&isset($_POST['submit'])) {
    ...
    if(isset($_FILES['upload'])&& isset($_POST['submit'])){
        ...
        $dest="intern_".$intern_id."_phase_".$phase;
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Please upload PDF File about the event and picutres of the event.<br><font color="red">MAX SIZE OF PDF FILE = 30MB</font></p>
                                        </div>
                                        <hr/>
                                ...
                                <div class="col-lg-6">
                                  <h3>Instructions for Uploading Report</h3><br>
                                   <p>
                                   1. Please upload submission as a single file.<br><br>
                                   <br><br>
                                 </p>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <?php
                                    $filename="submissions/intern_".$intern_id."_phase_".$phase.".pdf";
                                        if(file_exists($filename)){?>
                                             <a type="button" href="<?php echo $filename;?>">&nbsp;&nbsp;&nbsp;View File(Current Phase)&nbsp;&nbsp;&nbsp;</a>
                                          <br /><br />
                                         <form method="post" action="delete1.php" id="form1">
                                            <input type="hidden" name="type" value="general" />
                                             </form>
                                             <button name="submit1" class="btn btn-default" onclick="Form11()">Delete Submission(Current Phase)</button>
                                     <?php   
                                        }
				                     ?>
                                    <br /><br /><br />
