        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Fir and Other Clippings!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="fir.php">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Upload Phase<?php echo $phase;?> Report</div>
            </div>
      ...
      <?php if($phase=="2"){?>         
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <div class="mr-5">Upload Video/Audio Recordings</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="audio_video.php">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <?php $progress=$phase*20;?>
        
        <h3>Phase <?php echo $phase;?></h3>
        <div class="progress">
            <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $progress;?>" aria-valuemin="0" aria-valuemax="100" style="<?php echo "width:".$progress."%";?>">
            </div>
        </div>
      <div class="row">
