                     ...
                     <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="">
                                        <div class="form-group">
                                            <label>Name </label>
                                            <input class="form-control" name="teamname" value="<?php echo $name1;?>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Email </label>
                                            <input class="form-control" name="m2" value="<?php echo $email1;?>" placeholder="Enter text" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Contact</label>
                                            <input class="form-control" name="email3" value="<?php echo $contact1;?>" placeholder="Enter text" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="location" name="location" value="<?php echo $location1;?>" placeholder="Enter text" required readonly>
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Problem Statement *</label>
                                            <textarea name="problem" class="form-control" cols="70" rows="10"  required readonly><?php echo htmlspecialchars($problem1);?></textarea>
                                        </div>
                                    </form>
                        ...
                        <div class="col-lg-6">        
                           <form action="teamimgupload.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <?php 
                                        if ((strcmp($img1,"") == 0) || ($img1 == NULL)) {
                                            echo "<img src=\"Profile/teamimg.png\" height=\"250px\" id=\"output_image\" width=\"70%\">" ;
                                        } 
                                        else{
                                          echo "<img src='$img1' height=\"250px\" id=\"output_image\"   width=\"70%\">" ;
                                        } 
                                    ?>
                                    <br /><br />
                                </div>
