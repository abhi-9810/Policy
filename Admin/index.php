<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT username FROM policy_admin WHERE username = '$myusername' and password = '$mypassword'";
       echo $sql;
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header"><img src="http://road-safety.co.in/ISAFE/images/logo.jpg" height="50px" width="auto" alt="">IRSC Policy Admin Secure Login</div>
      <div class="card-body">
