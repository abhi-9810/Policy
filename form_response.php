  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Take Responses</li>
      </ol>
      <div class="row">
        <div class="col-12">
            <form role="form" method="post" action="forms_saveresponse.php" id="form">
                     <div class="row">
                                <div class="col-lg-6">
                                   <h2>Subjective</h2>          
                                     <br />
                                    <?php
                                      $table_id="policy_".$intern_id."_".$form_no;
                                      $sql="SELECT * FROM policy_phase2_subjective WHERE table_id='$table_id'";
                                      ...
                                      while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
                                          ...
                                          $aid="ans_sub".$i;
                                        ?>
                                        <label><b><?php echo $qid;?></b></label><textarea class='form-control' cols='10' rows='5' name='sub_1' placeholder='Enter Question' readonly><?php echo $ques;?></textarea>
                                        <br /><br />
                                        <textarea class='form-control' cols='10' rows='9' name='<?php echo $aid;?>' placeholder='Enter Answer' required></textarea>
                        ...
                        <div class="col-lg-6">        
                            <h2>Objective</h2>
                             <br />
                                 <?php
                                     $sql="SELECT * FROM policy_phase2_objective WHERE table_id='$table_id'";
                                      $result=mysqli_query($con,$sql);
                                      $i=1;
                                      while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
                                          $qid="Question".$i;
                                        ...
                                        <label><b><?php echo $qid;?></b></label><textarea class='form-control' cols='10' rows='5' name='sub_1' placeholder='Enter Question' readonly><?php echo $ques;?></textarea>
                                        <br />
                                         <input type="checkbox" name="<?php echo $aid."_1" ;?>" value="<?php echo $o1;?>"><?php echo $o1;?><br/>
                                         <input type="checkbox" name="<?php echo $aid."_2" ;?>" value="<?php echo $o2;?>"><?php echo $o2;?><br/>
                                         <input type="checkbox" name="<?php echo $aid."_3" ;?>" value="<?php echo $o3;?>"><?php echo $o3;?><br/>
                                         <input type="checkbox" name="<?php echo $aid."_4" ;?>" value="<?php echo $o4;?>"><?php echo $o4;?><br/>
                                         <br />           
                                <?php }
                                  $objective=$i;
                                ?>
                  ...
                  </div>     <input type="hidden" name="subjective" value="<?php echo $subjective;?>">
                             <input type="hidden" name="objective" value="<?php echo $objective;?>">
                             <input type="hidden" name="table_id" value="<?php echo $table_id;?>">
                             <div class="form-group">
                                 <br /><br /><br />
                                <button type="submit" name="submit" > SAVE RESPONSE </button>
                             </div>
            </form>
          </div>
      </div>
