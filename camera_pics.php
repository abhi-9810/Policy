        ...
        <div class="col-12">
          <h1>Camera</h1>    
            <div class="row">
                ...
                <div class="col-lg-6">    
                    <button id="snap" width="100%" height="480">Snap Photo</button>
                    <button id="save_pics">Save Location Clipping</button><br />
                    <canvas id="canvas" width="530" height="480"></canvas>
                   </div>
                    <script type="text/javascript">
                        ...
                        document.getElementById("snap").addEventListener("click", function() {
                            context.drawImage(video, 10, 10, 480, 390);
                        });
   
                        
                      document.getElementById("save_pics").addEventListener("click", function(){
		                  var dataUrl = canvas.toDataURL();
		                  $.ajax({
			                 type: "POST",
			                 url: "camsave_pics.php",
			                 data: { 
                                 imgBase64: dataUrl
			                 }
			             }).done(function(msg) {
