          ...
          <h1>Camera</h1>    
            <div class="row">
                ...
                <div class="col-lg-6">    
                    ...
                    <button id="save_news">Save NewsPaper Clipping</button><br />
                    ...
                    <script type="text/javascript">
                        ...
                        document.getElementById("snap").addEventListener("click", function() {
                            context.drawImage(video, 10, 15, 500, 390);
                        });
   
                        
                      document.getElementById("save_news").addEventListener("click", function(){
		                  var dataUrl = canvas.toDataURL();
		                  $.ajax({
			                 type: "POST",
			                 url: "camsave_news.php",
			                 data: { 
                                 imgBase64: dataUrl
			                 }
			             }).done(function(msg) {
