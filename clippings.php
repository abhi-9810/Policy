    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <?php        
                    $list = scandir('./NewsPaper_Clipping/');
                    foreach ($list as $val) {
                        $img="NewsPaper_Clipping/".$val;
                        $img1="policy_news_".$intern_id."_";
                        if (strpos($val,$img1) !== false) {
                     ?>
                     <div class="col-lg-4">
                       <img src="<?php echo $img;?>" style="width:100%;">
                         <button onclick="delete1('<?php echo $img;?>')" style="float:right;" name="submit" > Delete </button>
                     </div>
                   <?php
                        }
                    }
            ...
            <h1>Location Clippings</h1>
            <div class="row">
                <?php        
                    $list = scandir('./Location_Pics/');
                    foreach ($list as $val) {
                        $img="Location_Pics/".$val;
                        $img1="policy_pics_".$intern_id."_";
                        if (strpos($val,$img1) !== false) {
                     ?>
                     <div class="col-lg-4">
                       <img src="<?php echo $img;?>" style="width:100%;">
